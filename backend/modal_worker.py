...
stub = modal.Stub("eden-ai-worker")
...
@stub.function(
    ...
    secret=modal.Secret.from_name("eden-secrets"),  # HF_TOKEN, OPENAI_API_KEY, DATABASE_URL
    timeout=600,
)
...
@stub.function(
    image=image,
    secret=modal.Secret.from_name("eden-secrets"),
)
