                      ...
                      {paginatedMeetings.map((meeting) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 align-top">
                              <span className={`inline-flex items-center justify-center px-2 py-1 min-w-[90px] rounded-pill text-[11px] font-medium uppercase tracking-widest ${status.color}`}>
                                {status.label}
                              </span>
                            </td>
                            <td className="px-6 py-4 align-top text-right">
                              <div className="flex items-center justify-end gap-1 text-claeron-muted opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <button 
                                  ...
                                  className="p-1.5 hover:text-status-error-base rounded-button transition-colors" 
