...
// =============================================================================
// Action Items Tab Component - Claeron
// =============================================================================
    ...
    if (allItems.length === 0) {
        return (
            <div className="py-20 text-center flex flex-col items-center">
                ...
                <p className="text-[16px] font-medium text-claeron-text">No action items found</p>
                <p className="text-[14px] text-claeron-muted mt-2 max-w-[240px]">AI will extract tasks and follow-ups once processing is complete.</p>
            </div>
        );
    }
                ...
                {allItems.map((item) => (
                    ...
                    >
                        <div className="mt-1 flex-shrink-0">
                            <input 
                                type="checkbox" 
                                className="w-5 h-5 rounded border-claeron-border text-claeron-primary focus:ring-claeron-primary cursor-pointer" 
                            />
                        </div>

                        <div className="flex-1 min-w-0">
                            <p className="text-[15px] text-claeron-text leading-relaxed font-medium group-hover:text-claeron-primary transition-colors">
                                {item.text}
                            </p>

                            <div className="flex flex-wrap items-center gap-4 mt-4">
                                <div className={`flex items-center gap-1.5 px-2 py-0.5 rounded-pill text-[10px] font-medium uppercase tracking-widest ${item.decision ? 'bg-status-info-bg text-status-info-text' : 'bg-claeron-primary/10 text-claeron-primary'}`}>
                                    <Tag size={12} />
                                    {item.decision ? 'Decision' : 'Action'}
                                </div>

                                <div className="flex items-center gap-2 text-[12px] text-claeron-muted font-medium">
                                    <User size={14} />
                        ...
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                            <button className="p-1.5 bg-claeron-bg text-claeron-muted hover:text-claeron-primary rounded-button transition-colors">
